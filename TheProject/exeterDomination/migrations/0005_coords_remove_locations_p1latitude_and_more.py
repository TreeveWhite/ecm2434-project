...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('exeterDomination',
         '0004_rename_latitude_locations_p1latitude_and_more'), ]
    ...
    operations = [
        ...
        migrations.RemoveField(
            model_name='locations', name='p1Latitude',),
        migrations.RemoveField(
            model_name='locations', name='p1Longitude',),
        migrations.RemoveField(
            model_name='locations', name='p2Latitude',),
        migrations.RemoveField(
            model_name='locations', name='p2Longitude',),
